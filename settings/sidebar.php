        ...
        <div class="tab-content" id="nav-tabContent">
          ...
          <div class="tab-pane fade" id="list-about" role="tabpanel" aria-labelledby="list-about-list">
            ...
            <div class="card-body">
                <div class="form-group">
                  <h4>Developer</h4>
                  <p><i class="fas fa-user-circle"></i> Hilman Syahid Effrianto</p>
                  <p><i class="fas fa-envelope-open-text"></i> hilman.syahid@gmail.com</p> 
                  <p><i class="fas fa-phone-square-alt"></i> +62-831-7363-3645</p>                  
                  <p><i class="fab fa-github"></i> https://github.com/HilmanSyahid007</p>                  
                </div>
                <br>                
            </div>
            </div>
